    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-5xl gap-12 md:grid-cols-12 md:items-center">
        <div className="md:col-span-7">
          ...
          >
            Desarrollador Full Stack | Fundador de PassNow | Estudiante de Licenciatura en Gestión de Tecnología de la Información en UADE
          </motion.p>
          <motion.div {...anim(0.5)} className="flex flex-wrap gap-4">
            <a
              href="#proyectos"
