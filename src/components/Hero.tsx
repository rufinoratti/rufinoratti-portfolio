      ...
      <div className="relative mx-auto grid w-full max-w-5xl gap-12 md:grid-cols-12 md:items-center">
        <div className="md:col-span-7">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="#contacto"
              className="rounded-full border border-border px-7 py-3 text-sm font-medium text-ink transition-[border-color,transform] duration-200 ease-out-expo hover:border-ink active:scale-[0.97] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent"
            >
              Contactarme
            </a>
          </div>
